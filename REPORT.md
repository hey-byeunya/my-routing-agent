...
| 유형 | 건수 | 예 |
| --- | --- | --- |
| 필수 사실 누락 | 4 | N-003#4 — 브랜드 표기를 바로잡느라 운임 3,490원·제주 3,000원을 안 말함 |
| 되물음 누락 | 2 | N-001#2 — 크기·중량·택배사는 물었지만 "어떤 서비스인지"를 안 물음 |

둘 다 "필요한 것을 안 부른 것"이 아니라 **답변 본문이 근거의 일부를 빠뜨린 것**이다. 도구 호출은 24턴 전부 기대와 일치한다.
