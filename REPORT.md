...
### 지금 수치 (gpt-4o-mini, 평가 24턴 / 라우팅 36건)

| | 기준선 (#4) | 지금 (#18) |
| --- | --- | --- |
| **도구 호출 적절성** | 0.750 | **1.000** |
| **답변 적절성** | 0.583 | **0.875** |
| 행동 일치 (진단용) | 0.625 | 0.750 |
| 라우팅 정확도 (36건 단일 턴) | 0.889 | 0.889 |
| 폴백 | 0건 | 0건 |
| 가드레일 위반 | 1건 | 0건 |

라우팅은 LLM 없는 규칙 기준선 0.694 대비 0.889 다. "LLM 을 썼으니 좋아졌다"가 아니라 **규칙으로도 얼마까지 되는지**를 먼저 재 두었다.
