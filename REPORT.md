...
| #44<br>`openai/gpt-4o-mini` | `prompts.py ROUTE_GUIDE_RULES` | — | 품목 문의 좁은 규칙(서비스 단서 없을 때만 SPEC_SHIPPING) | 0.833 / 0.827 (42건) | — | — | — |
| #45<br>`openai/gpt-4o-mini` | — | — | 같은 세션 기준선 재측정 | 0.881 / 0.879 (42건) | — | — | — |
| #46<br>`openai/gpt-4o-mini` | — | — | 품목 규칙 v2 — 서비스어가 있으면 규칙 적용 금지를 명시 | 0.857 / 0.853 (42건) | — | — | — |
| #47<br>`openai/gpt-4o-mini` | — | — | 품목 규칙 v2 회귀 확인 | — | — | 라우팅 0.800(대안 0.967) · 되물음 1.000 | — |
| #48<br>`openai/gpt-4o-mini` | — | — | 품목 규칙 v2 반복 측정 (변동폭 확인) | 0.881 / 0.879 (42건) | — | — | — |
...
| #49<br>`openai/gpt-4o-mini` | — | — | 같은 세션 기준선 (품목 규칙 없음) | — | 1.000 / 0.871 (31턴) | — | — |
| #50<br>`openai/gpt-4o-mini` | — | — | 품목 규칙 v2 반복 측정 | — | 1.000 / 0.839 (31턴) | — | — |
| #51<br>`openai/gpt-4o-mini` | — | — | 품목 규칙 v3 (3줄로 줄임) | 0.881 / 0.879 (42건) | — | — | — |
| #52<br>`openai/gpt-4o-mini` | — | — | 품목 규칙 v3 회귀 확인 | — | — | 라우팅 0.800(대안 1.000) · 되물음 1.000 | #41 앞에 회차 번호 없이 남은 측정들은 이 회차의 탐색 기록이다. routing_openai_base_s2·answer_openai_base_s2 는 같은 세션에서 다시 잰 기준선이고, item2(규칙 7줄)는 라우팅 0.833 으로 떨어져 버렸다. item3(서비스어가 있으면 규칙을 쓰지 말라고 명시)은 라우팅은 되돌아왔지만 답변 적절성이 0.871 → 0.839 로 1턴 깎였고, 캐시를 지우고 다시 재도 같은 값이 나와 변동폭이 아니라 실제 손실로 확인됐다. 채택한 것은 규칙을 세 줄로 줄인 item4(v3)다. |
| #53<br>`openai/gpt-4o-mini` | — | — | §7.2 수정 뒤 반복 측정 (변동폭) | — | 1.000 / 0.871 (31턴) | — | #41 마무리. §7.2 '포장 기준' 표 한가운데에 산문이 끼어 있어 표가 둘로 쪼개져 있던 것을 표 아래로 옮겼다. 직후 측정이 답변 0.871 → 0.806 으로 떨어졌지만 캐시를 비워 다시 재니 0.871 로 돌아왔다 — 변동폭이다. 바뀐 두 턴(C-001#2 운임 되물음, N-004#2 박스 규격)은 §7 과 무관한 문의였다. |
